...
- **User Management (Admin Only):** A dedicated interface for administrators to manage system access, including a centralized list of pending registrations for rapid approval.
